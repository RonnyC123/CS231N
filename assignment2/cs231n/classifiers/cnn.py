...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        relu_out2, relu_cache2 = relu_forward(affine_out)
        scores, scores_cache = affine_forward(relu_out2, W3, b3)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dscores, scores_cache)
